  ...
  return (
    <div className="space-y-6 max-w-lg">
      ...
      <motion.div
        ...
        animate="visible"
      >
        <motion.div whileHover={dirty ? { scale: 1.02 } : undefined} whileTap={dirty ? { scale: 0.97 } : undefined}>
    ...
    <div className="space-y-1.5">
      <div className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={onToggle}
          className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 ${
            show ? "bg-primary" : "bg-muted"
          }`}
          role="switch"
          aria-checked={show}
        >
